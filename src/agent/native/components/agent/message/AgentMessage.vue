...
<template>
  <div class="ctv:space-y-2 ctv:pb-4">
    ...
    >
      <span :class="cn('ctv:size-4 ctv:shrink-0', status.icon)" />
      <span class="agent-shimmer-text ctv:min-w-0 ctv:truncate">{{ status.text }}</span>
    </div>
