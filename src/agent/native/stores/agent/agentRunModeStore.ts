...
const PREFERENCE_STORAGE_KEY = 'ComfyTV.Agent.RunModePreference'
const LEGACY_MODE_STORAGE_KEY = 'ComfyTV.Agent.RunMode'
const LEGACY_CREDIT_LIMIT_STORAGE_KEY = 'ComfyTV.Agent.RunCreditLimit'
