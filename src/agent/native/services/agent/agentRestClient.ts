...
export function createAgentRestClient() {
  ...
  async function getRunMode(): Promise<AgentRunModePreference> {
    return request('/comfytv/agent/run-mode', { method: 'GET' }, zAgentRunMode)
  }
  ...
  async function listCloudWorkflows(): Promise<CloudWorkflowEntry[]> {
    ...
    do {
      ...
      const result = await request(
        `/comfytv/agent/workflows?limit=${CLOUD_WORKFLOW_PAGE_SIZE}${after}`,
        { method: 'GET' },
        zCloudWorkflowIndex
      )
  ...
  async function cancelMessage(
    ...
    return request(
      `/comfytv/agent/threads/${encodeURIComponent(threadId)}/messages/${encodeURIComponent(messageId)}/cancel`,
      jsonInit('POST', {}),
      zAgentCancelAccepted
    )
  }
  ...
  async function answerAsk(
    ...
    return request(
      `/comfytv/agent/threads/${encodeURIComponent(threadId)}/asks/${encodeURIComponent(askId)}/answer`,
